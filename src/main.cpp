...
unsigned int nStakeMinAge = 24 * 60 * 60; // 1 day as zero time weight
unsigned int nStakeMaxAge = 36 * 30 * 24 * 60 * 60; // 36 months as full weight
int64_t nTargetSpacing = 30;  // Time between reward:    30 Second
...
// miner's coin base reward premine -- Premined:1.750.000.000
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // usdex: check proof-of-stake block signature
...
// usdex: attempt to generate suitable proof-of-stake
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "usdex.com Block";
        CTransaction txNew;
        txNew.nTime = 1544600142;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1544600142;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2318541;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xb4d345d61ff3662d43587a640c22b1ba183d9d9744e50c22964c6cb129bad5aa"));
        block.print();
